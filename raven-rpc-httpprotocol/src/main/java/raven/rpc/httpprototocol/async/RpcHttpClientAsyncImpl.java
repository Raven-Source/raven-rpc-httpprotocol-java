...
import raven.rpc.httpprototocol.extension.CompletableFutureExtensions;
...
public class RpcHttpClientAsyncImpl
    ...
    public <TData, TResult> CompletableFuture<TResult> invokeAsync(final Class<TResult> resultClazz, final String url, final TData contentData, final Map<String, String> urlParameters, final HttpMethod httpMethod, final int timeout)
        ...
        //http异步执行
        client.execute(_httpHost, httpRequest, CompletableFutureExtensions.shiftToFutureCallback(completableFuture
        ...
        CompletableFuture<TResult> res = CompletableFutureExtensions.withTimeout(completableFuture, duration);
